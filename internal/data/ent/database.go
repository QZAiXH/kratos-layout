...
// CasbinRule 返回 CasbinRule builder 客户端。
func (db *Database) CasbinRule(ctx context.Context) *CasbinRuleClient {
	return db.loadClient(ctx).CasbinRule
}
