...
// TodoEventType identifies the type of todo change carried by a TodoEvent.
type TodoEventType int32

const (
	// Default value used when the event type is unknown.
	TodoEventType_TODO_EVENT_TYPE_UNSPECIFIED TodoEventType = 0
	// A todo item was created.
	TodoEventType_TODO_EVENT_TYPE_CREATED TodoEventType = 1
	// A todo item was updated.
	TodoEventType_TODO_EVENT_TYPE_UPDATED TodoEventType = 2
	// A todo item was deleted.
	TodoEventType_TODO_EVENT_TYPE_DELETED TodoEventType = 3
	// A snapshot event emitted when a stream is first opened.
	TodoEventType_TODO_EVENT_TYPE_SNAPSHOT TodoEventType = 4
)

// Enum value maps for TodoEventType.
var (
	TodoEventType_name = map[int32]string{
		0: "TODO_EVENT_TYPE_UNSPECIFIED",
		1: "TODO_EVENT_TYPE_CREATED",
		2: "TODO_EVENT_TYPE_UPDATED",
		3: "TODO_EVENT_TYPE_DELETED",
		4: "TODO_EVENT_TYPE_SNAPSHOT",
	}
	TodoEventType_value = map[string]int32{
		"TODO_EVENT_TYPE_UNSPECIFIED": 0,
		"TODO_EVENT_TYPE_CREATED":     1,
		"TODO_EVENT_TYPE_UPDATED":     2,
		"TODO_EVENT_TYPE_DELETED":     3,
		"TODO_EVENT_TYPE_SNAPSHOT":    4,
	}
)

func (x TodoEventType) Enum() *TodoEventType {
	p := new(TodoEventType)
	*p = x
	return p
}

func (x TodoEventType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TodoEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_todo_v1_todo_proto_enumTypes[0].Descriptor()
}

func (TodoEventType) Type() protoreflect.EnumType {
	return &file_todo_v1_todo_proto_enumTypes[0]
}

func (x TodoEventType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TodoEventType.Descriptor instead.
func (TodoEventType) EnumDescriptor() ([]byte, []int) {
...
type TodoEvent struct {
	...
	Type          TodoEventType `protobuf:"varint,4,opt,name=type,proto3,enum=todo.v1.TodoEventType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TodoEvent) GetType() TodoEventType {
	if x != nil {
		return x.Type
	}
	return TodoEventType_TODO_EVENT_TYPE_UNSPECIFIED
}
...
const file_todo_v1_todo_proto_rawDesc = "" +
	...
	"\x04type\x18\x04 \x01(\x0e2\x16.todo.v1.TodoEventTypeR\x04type*\xa5\x01\n" +
	"\rTodoEventType\x12\x1f\n" +
	"\x1bTODO_EVENT_TYPE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17TODO_EVENT_TYPE_CREATED\x10\x01\x12\x1b\n" +
	"\x17TODO_EVENT_TYPE_UPDATED\x10\x02\x12\x1b\n" +
	"\x17TODO_EVENT_TYPE_DELETED\x10\x03\x12\x1c\n" +
	"\x18TODO_EVENT_TYPE_SNAPSHOT\x10\x042\xe9\x04\n" +
	"\vTodoService\x12W\n" +
	"\n" +
	...
	"\tSyncTodos\x12\x18.todo.v1.SyncTodoRequest\x1a\x12.todo.v1.TodoEvent\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/todos/sync(\x010\x01B7\n" +
	"\x18io.grpc.examples.todo.v1B\tTodoProtoP\x01Z\x0eapi/todo/v1;v1b\x06proto3"
...
var file_todo_v1_todo_proto_goTypes = []any{
	(TodoEventType)(0),            // 0: todo.v1.TodoEventType
...
var file_todo_v1_todo_proto_depIdxs = []int32{
	11, // 0: todo.v1.Todo.create_time:type_name -> google.protobuf.Timestamp
	11, // 1: todo.v1.Todo.update_time:type_name -> google.protobuf.Timestamp
	1,  // 2: todo.v1.TodoSet.todos:type_name -> todo.v1.Todo
	1,  // 3: todo.v1.CreateTodoRequest.todo:type_name -> todo.v1.Todo
	1,  // 4: todo.v1.UpdateTodoRequest.todo:type_name -> todo.v1.Todo
	12, // 5: todo.v1.UpdateTodoRequest.update_mask:type_name -> google.protobuf.FieldMask
	1,  // 6: todo.v1.SyncTodoRequest.todo:type_name -> todo.v1.Todo
	12, // 7: todo.v1.SyncTodoRequest.update_mask:type_name -> google.protobuf.FieldMask
	1,  // 8: todo.v1.TodoEvent.todo:type_name -> todo.v1.Todo
	11, // 9: todo.v1.TodoEvent.event_time:type_name -> google.protobuf.Timestamp
	0,  // 10: todo.v1.TodoEvent.type:type_name -> todo.v1.TodoEventType
	...
	5,  // 13: todo.v1.TodoService.ListTodos:input_type -> todo.v1.ListTodosRequest
	...
	8,  // 16: todo.v1.TodoService.WatchTodos:input_type -> todo.v1.WatchTodosRequest
	...
	1,  // 19: todo.v1.TodoService.GetTodo:output_type -> todo.v1.Todo
	2,  // 20: todo.v1.TodoService.ListTodos:output_type -> todo.v1.TodoSet
	1,  // 21: todo.v1.TodoService.UpdateTodo:output_type -> todo.v1.Todo
	13, // 22: todo.v1.TodoService.DeleteTodo:output_type -> google.protobuf.Empty
	10, // 23: todo.v1.TodoService.WatchTodos:output_type -> todo.v1.TodoEvent
